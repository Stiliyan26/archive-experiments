...
public class LoiContractStatus extends ListOptionItem {

	public static final Long NOT_SIGNED = 1L;
	public static final Long SIGNED = 2L;
	public static final Long AN_ANNEX_IS_EXPECTED = 3L;
	...
	public LoiContractStatus() {
	}

	public LoiContractStatus(SecUser createdBy, Date createdDate, SecUser lastModifiedBy, Date lastModifiedDate, boolean calculateOnly, ManagedCompany company, String listOptionItemName, Long listOptionItemCode) {

...
public class LoiProtocolLineCount extends ListOptionItem {

	public static final Long ONE_LINE = 1L;
	public static final Long THREE_LINES = 3L;


	@JsonIgnore //avoid serialization recursion by Jackson
	@OneToMany(mappedBy = "loiProtocolLineCount")
	...
	public LoiProtocolLineCount() {
	}

	public LoiProtocolLineCount(SecUser createdBy, Date createdDate, SecUser lastModifiedBy, Date lastModifiedDate, boolean calculateOnly, ManagedCompany company, String listOptionItemName, Long listOptionItemCode) {

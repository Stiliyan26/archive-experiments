...
//---------------------------------------------------------------------------------------------
    ...
    public Set<Map<String, Set<String>>> populateElectricityInvoice(
            PopulateElectricityInvoiceRequest populateElectricityInvoiceRequest
    ) {
        ManagedCompany company = dbSecUserService.getCurrentUserManagedCompany();

        System.out.println(populateElectricityInvoiceRequest);
        ...
        LoiDocumentType loiDocumentType = parseLoiDocumentTypeFromPopulateRequest(populateElectricityInvoiceRequest.getDocumentTypeCode(), loiDocumentTypeMap);
        ...
        Set<Map<String, Set<String>>> fetchAndPopulateImportValueEntries = importFilesService
                .fetchAndPopulateImportValueEntries(
                        populateElectricityInvoiceRequest.getPeriodFrom(),
                        populateElectricityInvoiceRequest.getPeriodTo(),
                        populateElectricityInvoiceRequest.getTaxEventDate(),
                        loiDocumentType,
                        loiDocumentTypeMap,
                        populateElectricityInvoiceRequest.getAgreementTypeCodes(),
                        agreementTypeMappingSet,
                        populateElectricityInvoiceRequest.getPowerPlantIds(),
                        company
                );

        Set<Map<String, Set<String>>> fetchAndPopulateImportQuantityEntries = importFilesService
                .fetchAndPopulateImportQuantityEntries(
                        populateElectricityInvoiceRequest.getPeriodFrom(),
                        populateElectricityInvoiceRequest.getPeriodTo(),
                        populateElectricityInvoiceRequest.getTaxEventDate(),
                        loiDocumentType,
        ...
        Set<Map<String, Set<String>>> fetchAndPopulateImportValueAndQuantityEntries = importFilesService
                .fetchAndPopulateImportValueAndQuantityEntries(
                        populateElectricityInvoiceRequest.getPeriodFrom(),
                        populateElectricityInvoiceRequest.getPeriodTo(),
                        populateElectricityInvoiceRequest.getTaxEventDate(),
                        loiDocumentType,

...
class PageTableAgreementTypeContainer extends React.Component {
    componentDidMount() {
    ...
    render() {
        let columns = getEntityDefinition(this.props.entityName, { id: { show: "hidden" }}).columns;
            ...
            <div className="page-body-wrapper">
                ...
                <div className='page-body'>
                    <EmbedRetrieveEntityListContainer
                        ...
                        columns={columns}
                        title={this.props.t(`${selfieEntities.AgreementType.className}._className_plural`)}
...
function mapStateToProps(state, ownProps) {
    const entityDef = getEntityDefinition(selfieEntities.AgreementType.pluralCamelCase, undefined);
    const componentPath = "PageTable" + entityDef.className;
    const title = ownProps.t(`${selfieEntities.AgreementType.className}._className_plural`);
...
const ConnectComponent = connect(mapStateToProps, mapDispatchToProps)(PageTableAgreementTypeContainer);

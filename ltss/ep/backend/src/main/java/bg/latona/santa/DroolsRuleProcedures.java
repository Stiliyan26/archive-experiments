...
public class DroolsRuleProcedures {
	...
	public ImportXenergieInvoice findImportXenergieInvoiceByBillingDateAndZnumberAndProductAndCompanyAndDeleted(LocalDate billingDate, String znumber, String product, ManagedCompany company, boolean deleted) {
		ImportXenergieInvoiceRepository repo = ((ImportXenergieInvoiceRepository) getRepositories().getRepositoryFor(ImportXenergieInvoice.class).get());
		return repo.findFirstByBillingDateAndZnumberAndProductAndCompanyAndDeleted(billingDate, znumber, product, company, deleted);
	}
	...
	public PowerPlant findPowerPlantByIdentificationNumberAndCompanyAndDeleted(String identificationNumber, ManagedCompany company, boolean deleted) {
		PowerPlantRepository repo = ((PowerPlantRepository) getRepositories().getRepositoryFor(PowerPlant.class).get());
		return repo.findFirstByIdentificationNumberAndCompanyAndDeleted( identificationNumber, company, deleted);
	}
	
	public PowerPlant findPowerPlantByProducerEicAndCompanyAndDeleted(String producerEic, ManagedCompany company, boolean deleted) {
		PowerPlantRepository repo = ((PowerPlantRepository) getRepositories().getRepositoryFor(PowerPlant.class).get());
		return repo.findFirstByProducerEicAndCompanyAndDeleted( producerEic, company, deleted);
	}
...
//		if (entity instanceof ElectricityInvoice) return findElectricityInvoiceByReportingPointOwnAndPeriodFromAndPeriodToAndCompanyAndDeleted(((ElectricityInvoice) entity).getReportingPointOwn(), ((ElectricityInvoice) entity).getPeriodFrom(), ((ElectricityInvoice) entity).getPeriodTo(), ((ElectricityInvoice) entity).getCompany(), false);
		...
		// Anvoice
		if (entity instanceof ImportXenergieInvoice) return findImportXenergieInvoiceByBillingDateAndZnumberAndProductAndCompanyAndDeleted(((ImportXenergieInvoice) entity).getBillingDate(), ((ImportXenergieInvoice) entity).getZnumber(), ((ImportXenergieInvoice) entity).getProduct(), ((ImportXenergieInvoice) entity).getCompany(), false);

...
const C_PRICE_LIST_DOT_CLASS_NAME = "CPriceList._className"
const C_PRICE_LISTS_VIEW = "cPriceListsView"

//Page: can be used as a landing page
//View: presents details of object
//Container: redux container class
class PageViewCPriceListContainer extends React.Component {	
	componentDidMount(){
		...
		return (
			<div className={PAGE_BODY_WRAPPER}>
				...
				<EmbedEntityContainer
					...
					entityName={C_PRICE_LISTS}
					headerText={this.props.t(C_PRICE_LIST_DOT_CLASS_NAME)}
					creatable={false}
					expanded={true}
				/>;
				{body}
...
function mapStateToProps(state,ownProps) {
	const entityName = C_PRICE_LISTS;
	const entityDef = getEntityDefinition(entityName,undefined);
	const componentPath = C_PRICE_LISTS_VIEW;
	...
	return {
		...
		//UI
		headerText: ownProps.t(C_PRICE_LIST_DOT_CLASS_NAME),
	};
}
...
const ConnectComponent = connect(mapStateToProps, mapDispatchToProps)(PageViewCPriceListContainer);

...
public class EventValidateAndIssueElectricityInvoice extends UserActionEvent {

    @ManyToOne
    private ElectricityInvoice electricityInvoice;

    public EventValidateAndIssueElectricityInvoice() {};

    public EventValidateAndIssueElectricityInvoice(SecUser createdBy, Date createdDate, SecUser lastModifiedBy, Date lastModifiedDate, boolean calculateOnly, ManagedCompany company,

...
const DOT = "."
const C_PMT_CURRENCY_RATES = "cPmtCurrencyRates"
const PAGE_VIEW_C_PMT_CURRENCY_RATE_CONTAINER = "PageViewCPmtCurrencyRateContainer"
const C_PMT_CURRENCY_RATE_DOT_CLASS_NAME = "CPmtCurrencyRate._className"


//Page: can be used as a landing page
//View: presents details of object
//Container: redux container class
class PageViewCPmtCurrencyRateContainer extends React.Component {	
	componentDidMount(){
...
function mapStateToProps(state,ownProps) {
	const entityName = C_PMT_CURRENCY_RATES;
	const entityDef = getEntityDefinition(entityName,undefined);
	const componentPath = PAGE_VIEW_C_PMT_CURRENCY_RATE_CONTAINER;
	...
	return {
		...
		//UI
		headerText: ownProps.t(C_PMT_CURRENCY_RATE_DOT_CLASS_NAME),
	};
}
...
const ConnectComponent = connect(mapStateToProps, mapDispatchToProps)(PageViewCPmtCurrencyRateContainer);

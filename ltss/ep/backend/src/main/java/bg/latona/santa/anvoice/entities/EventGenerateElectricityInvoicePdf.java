...
public class EventGenerateElectricityInvoicePdf extends UserActionEvent {

    @ManyToOne
    private ElectricityInvoice electricityInvoice;

    public EventGenerateElectricityInvoicePdf() {};

    public EventGenerateElectricityInvoicePdf(SecUser createdBy, Date createdDate, SecUser lastModifiedBy, Date lastModifiedDate, boolean calculateOnly, ManagedCompany company,

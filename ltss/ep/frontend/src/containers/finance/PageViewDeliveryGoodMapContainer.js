...
const C_DELIVERY_GOOD_MAP_DOT_CLASS_NAME = "CDeliveryGoodMap._className"
const DELIVERY_GOOD_MAPS_VIEW = "deliveryGoodMapsView"

//Page: can be used as a landing page
//View: presents details of object
//Container: redux container class
class PageViewDeliveryGoodMapContainer extends React.Component {	
	componentDidMount(){
		...
		return (
			<div className={PAGE_BODY_WRAPPER}>
				...
				<EmbedEntityContainer
					...
					entityName={C_DELIVERY_GOOD_MAPS}
					headerText={this.props.t(C_DELIVERY_GOOD_MAP_DOT_CLASS_NAME)}
					creatable={false}
					expanded={true}
				/>;
				{body}
...
function mapStateToProps(state,ownProps) {
	const entityName = C_DELIVERY_GOOD_MAPS;
	const entityDef = getEntityDefinition(entityName,undefined);
	const componentPath = DELIVERY_GOOD_MAPS_VIEW;
	...
	return {
		...
		//UI
		headerText: ownProps.t(C_DELIVERY_GOOD_MAP_DOT_CLASS_NAME),
	};
}
...
const ConnectComponent = connect(mapStateToProps, mapDispatchToProps)(PageViewDeliveryGoodMapContainer);

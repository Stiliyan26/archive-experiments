...
curl  -H "Authorization: xBasic YWRtaW46Y21MaExJWlFLMjhUUkEyNUJ4RnVHQ1dEVlNUSFZITU5yb3pIUmNzYWdvNEc4QW5oZzVJMm5TOHpDREgwaU5rZA==" -o santa_anvoice.jar $ARTIFACT_URL
...
const DOT = "."
const QUARTER_OF_HOURS = "quarterOfHours"
const QUARTER_OF_HOUR_DOT_CLASS_NAME = "QuarterOfHour._className"
const QUARTER_OF_HOUR_VIEW = "quarterOfHourView"

//Page: can be used as a landing page
//View: presents details of object
//Container: redux container class
class PageViewQuarterOfHourContainer extends React.Component {	
	componentDidMount(){
		...
		return (
			<div className={PAGE_BODY_WRAPPER}>
				...
				<EmbedEntityContainer
					...
					entityName={QUARTER_OF_HOURS}
					headerText={this.props.t(QUARTER_OF_HOUR_DOT_CLASS_NAME)}
					creatable={false}
					expanded={true}
				/>;
				{body}
...
function mapStateToProps(state,ownProps) {
	const entityName = QUARTER_OF_HOURS;
	const entityDef = getEntityDefinition(entityName,undefined);
	const componentPath = QUARTER_OF_HOUR_VIEW;
	...
	return {
		...
		//UI
		headerText: ownProps.t(QUARTER_OF_HOUR_DOT_CLASS_NAME),
	};
}
...
const ConnectComponent = connect(mapStateToProps, mapDispatchToProps)(PageViewQuarterOfHourContainer);

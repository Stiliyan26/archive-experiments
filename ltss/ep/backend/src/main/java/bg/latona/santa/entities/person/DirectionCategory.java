...
public class DirectionCategory extends CompanyRecord {
	...
	public DirectionCategory() {}

	public DirectionCategory(SecUser createdBy, Date createdDate, SecUser lastModifiedBy, Date lastModifiedDate, boolean calculateOnly, ManagedCompany company,

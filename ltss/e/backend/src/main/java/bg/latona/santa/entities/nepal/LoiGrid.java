...
public class LoiGrid extends ListOptionItem {

	public static final Long HIGH_VOLTAGE = 1L;
	public static final Long MID_VOLTAGE = 2L;
	...
	public LoiGrid(SecUser createdBy, Date createdDate, SecUser lastModifiedBy, Date lastModifiedDate, boolean calculateOnly, ManagedCompany company, String listOptionItemName, Long listOptionItemCode) {

...
*/
    ...
    @PostMapping(value = "/populateElectricityInvoice")
    public Set<Map<String, Set<String>>> populateElectricityInvoice(
            @RequestBody PopulateElectricityInvoiceRequest populateElectricityInvoiceRequest
    ) {
        return electricityInvoiceService.populateElectricityInvoice(populateElectricityInvoiceRequest);
    }

...
const DOT = "."
const C_CT_CURRENCIES = "cCtCurrencies"
const PAGE_VIEW_C_CT_CURRENCY_CONTAINER = "PageViewCCtCurrencyContainer"
const C_CT_CURRENCY_CLASS_NAME = "CCtCurrency._className"

//Page: can be used as a landing page
//View: presents details of object
//Container: redux container class
class PageViewCCtCurrencyContainer extends React.Component {	
	componentDidMount(){
...
function mapStateToProps(state,ownProps) {
	const entityName = C_CT_CURRENCIES;
	const entityDef = getEntityDefinition(entityName,undefined);
	const componentPath = PAGE_VIEW_C_CT_CURRENCY_CONTAINER;
	...
	return {
		...
		//UI
		headerText: ownProps.t(C_CT_CURRENCY_CLASS_NAME),
	};
}
...
const ConnectComponent = connect(mapStateToProps, mapDispatchToProps)(PageViewCCtCurrencyContainer);

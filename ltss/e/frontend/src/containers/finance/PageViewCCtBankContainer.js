...
const DOT = "."
const C_CT_BANKS = "cCtBanks"
const PAGE_VIEW_C_CT_BANK_CONTAINER = "PageViewCCtBankContainer"
const C_CT_BANK_CLASS_NAME = "CCtBank._className"

//Page: can be used as a landing page
//View: presents details of object
//Container: redux container class
class PageViewCCtBankContainer extends React.Component {
	componentDidMount(){
...
function mapStateToProps(state,ownProps) {
	const entityName = C_CT_BANKS;
	const entityDef = getEntityDefinition(entityName,undefined);
	const componentPath = PAGE_VIEW_C_CT_BANK_CONTAINER;
	...
	return {
		...
		//UI
		headerText: ownProps.t(C_CT_BANK_CLASS_NAME),
	};
}
...
const ConnectComponent = connect(mapStateToProps, mapDispatchToProps)(PageViewCCtBankContainer);

...
const DOT = "."
const SLASH_ADD = "/add"
const PAGE_VIEW_CT_BATCH_TYPE_RULE_CONTAINER= "PageViewCtBatchTypeRuleContainer"
const F_CT_BATCH_TYPE_RULE_CLASS_NAME = "FCtBatchTypeRule._className"

//Page: can be used as a landing page
//View: presents details of object
//Container: redux container class
class PageViewCtBatchTypeRuleContainer extends React.Component {
  componentDidMount(){
...
function mapStateToProps(state,ownProps) {
  const entityName = F_CT_BATCH_TYPE_RULES;
  const entityDef = getEntityDefinition(entityName, undefined);
  const componentPath = PAGE_VIEW_CT_BATCH_TYPE_RULE_CONTAINER;
  ...
  return {
    ...
    //UI
    headerText: ownProps.t(F_CT_BATCH_TYPE_RULE_CLASS_NAME),
  };
}
...
const ConnectComponent = connect(mapStateToProps, mapDispatchToProps)(PageViewCtBatchTypeRuleContainer);

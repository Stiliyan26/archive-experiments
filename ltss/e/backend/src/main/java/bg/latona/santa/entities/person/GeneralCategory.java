...
public class GeneralCategory extends CompanyRecord {
	...
	public GeneralCategory(SecUser createdBy, Date createdDate, SecUser lastModifiedBy, Date lastModifiedDate, boolean calculateOnly, ManagedCompany company,
